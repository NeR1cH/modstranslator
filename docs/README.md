...
|--------|------|----------|
| [v3.18.0](./releases/v3.18.0.md) | 09.05.2026 | Universal FragmentCache + Gender Agreement ⭐ |
...
- **[v3.18.0](./releases/v3.18.0.md)** (09.05.2026) - Universal FragmentCache + Gender Agreement
  ...
  - Автоматическое согласование по роду
...
**Последнее обновление:** 09.05.2026 11:41  
