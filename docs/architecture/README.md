...
### [Gender Agreement System](./GENDER_AGREEMENT_SYSTEM.md)

**Версия:** 3.18.0  
**Статус:** ✅ Production Ready

Система автоматического согласования прилагательных с существительными по роду в русском языке.

**Компоненты:**
- **detectAdjectiveGender()** - определение рода по окончанию
- **normalizeToMasculine()** - нормализация к мужскому роду
- **applyGenderAgreement()** - применение правильного окончания
...
📖 [Полная документация](./GENDER_AGREEMENT_SYSTEM.md)
...
- **FragmentCache** - универсальный кэш фрагментов (работает с любым контентом)
- **TemplateCache** - кэш шаблонов предложений
...
- Сохранение на диск
- Работа с любым контентом (UI, описания, квесты, предметы)
